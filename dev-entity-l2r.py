...
perceptrons = [
    ("gold_trajectory",
     entity_left_to_right.EntityLeftToRightPerceptronWithGoldRollIn),
    ("learned_trajectory",
     entity_left_to_right.EntityLeftToRightPerceptronWithLearnedRollIn)
]

for p_tuple in perceptrons:
    p_desc, p = p_tuple

    output_name = "entity-left_to_right-"+p_desc
