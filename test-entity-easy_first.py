...
configs = [
    ...
    ("test-entity-easy_first-learned-trajectory", entity.extract_substructures,
     entity.extract_substructures, entity_easy_first.EntityEasyFirstPerceptronWithLearnedRollIn,
     entity_easy_first.EntityEasyFirstPerceptronWithLearnedRollIn, cost_functions.cost_based_on_consistency_21, 200, 22, clusterer.all_ante),
    ("test-entity-easy_first-gold-trajectory", entity.extract_substructures,
