...
configs = [
    ...
    ("test-ranking-mod_soon", mention_ranking.extract_training_substructures_mod_soon,
     mention_ranking.extract_substructures, mention_ranking.RankingPerceptronClosest,
     mention_ranking.RankingPerceptron, cost_functions.null_cost, 0, 19, clusterer.all_ante),
    ("test-ranking-all_ante", mention_ranking.extract_training_substructures_all_ante,
     mention_ranking.extract_substructures, mention_ranking.RankingPerceptronClosest,
     mention_ranking.RankingPerceptron, cost_functions.null_cost, 0, 4, clusterer.all_ante),
    ("test-ranking-no_cost", mention_ranking.extract_substructures,
     mention_ranking.extract_substructures, mention_ranking.RankingPerceptronClosest,
     mention_ranking.RankingPerceptron, cost_functions.null_cost, 0, 10, clusterer.all_ante),
]
