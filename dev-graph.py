...
ie_and_perceptrons = [
    ("per_ana", graph_based.extract_per_anaphor_substructures, graph_based.GraphPerceptronPerAnaphor, graph_based.GraphPerceptronPerAnaphor),
    ("per_doc", graph_based.extract_per_document_substructures, graph_based.GraphPerceptronPerDocument, graph_based.GraphPerceptronPerDocument),
]
...
for ie_and_perceptrons_tuple in ie_and_perceptrons:
    ...
    for cost_func_tuple in cst_funcs:
        ...
        for cost_scaling in cost_scalings:
            output_name = "graph-" + desc + "-cost-" + cost_func_desc + "-scaling-" + str(cost_scaling)
