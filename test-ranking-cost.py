...
configs = [
    ...
    ("test-ranking-closest", mention_ranking.extract_substructures,
     mention_ranking.extract_substructures, mention_ranking.RankingPerceptronClosest,
     mention_ranking.RankingPerceptron, cost_functions.cost_based_on_consistency_21, 200, 18, clusterer.all_ante),
    ("test-ranking-latent", mention_ranking.extract_substructures,
     mention_ranking.extract_substructures, mention_ranking.RankingPerceptron,
     mention_ranking.RankingPerceptron, cost_functions.cost_based_on_consistency_21, 200, 12, clusterer.all_ante),
    ("test-ranking-tree", antecedent_trees.extract_substructures,
     antecedent_trees.extract_substructures, antecedent_trees.AntecedentTreePerceptron,
     antecedent_trees.AntecedentTreePerceptron, cost_functions.cost_based_on_consistency_31, 100, 19, clusterer.all_ante),
]
