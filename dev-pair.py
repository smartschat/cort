...
coref_extractors = [
    ("aggressive_merge", clusterer.aggressive_merge),
    ("closest_first", clusterer.closest_first),
    ("best_first", clusterer.best_first),
]

instance_extractor_functions = [
    ("all", mention_pairs.extract_testing_substructures),
    ("soon", mention_pairs.extract_training_substructures_soon),
    ("mod_soon", mention_pairs.extract_training_substructures_mod_soon)
]
