...
configs = [
    ...
    ("test-entity-l2r-learned-trajectory", entity.extract_substructures,
     entity.extract_substructures, entity_left_to_right.EntityLeftToRightPerceptronWithLearnedRollIn,
     entity_left_to_right.EntityLeftToRightPerceptronWithLearnedRollIn, cost_functions.cost_based_on_consistency_21, 200, 16, clusterer.all_ante),
    ("test-entity-l2r-gold-trajectory", entity.extract_substructures,
     entity.extract_substructures, entity_left_to_right.EntityLeftToRightPerceptronWithGoldRollIn,
     entity_left_to_right.EntityLeftToRightPerceptronWithGoldRollIn, cost_functions.cost_based_on_consistency_21,
     200, 24, clusterer.all_ante),
]
